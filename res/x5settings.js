(function ( $, x5engine ) {
	...
	s.siteId = '5DF7A05D7F5417A2B3410B180C0585E8';
	s.islocal = true;
	s.version = '2019-3-11-0';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'C', path: 'captcha/imcpa_488.gif'},
				"1": { letter: '3', path: 'captcha/imcpa_kyp.gif'},
				"2": { letter: 'C', path: 'captcha/imcpa_ntt.gif'},
				"3": { letter: 'Z', path: 'captcha/imcpa_rzw.gif'},
				"4": { letter: 'A', path: 'captcha/imcpa_ydy.gif'},
				"5": { letter: 'Z', path: 'captcha/imcpa_rak.gif'},
				"6": { letter: 'D', path: 'captcha/imcpa_clf.gif'},
				"7": { letter: 'C', path: 'captcha/imcpa_xmz.gif'},
				"8": { letter: 'T', path: 'captcha/imcpa_tw6.gif'},
				"9": { letter: 'E', path: 'captcha/imcpa_jr8.gif'}
			}
		});
	}, false, 'first');
